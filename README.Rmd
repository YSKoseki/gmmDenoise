...
gmmDenoise is a set of functions for denoising amplicon sequence variants (ASVs) inferred from metabarcoding analysis, based on Gaussian mixture modeling (GMM).
...
This is an example of how gmmDenoise works for denoising metabarcoding sequence data.

```{r, results = 'hide'}
library(gmmDenoise)
```

```{r example, warning = FALSE, results = 'hide'}
